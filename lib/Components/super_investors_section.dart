      ...
      builder: (context, snapshot) {
        ...
        final rows = _buildRows(investors, isDarkMode: isDarkMode);
          final columns = [
            ...
            SimpleColumn(label: 'P Share', fieldName: 'previousShares', isNumeric: true),
            ...
            // "Decreasing" / "Increasing" need ~110px+ with cell pad + ⋮ chrome.
            SimpleColumn(label: 'TREND', fieldName: 'trend', width: 118),
            SimpleColumn(
              label: 'CONVICTION',
