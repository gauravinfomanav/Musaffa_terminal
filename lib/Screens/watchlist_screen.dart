...
import 'package:musaffa_terminal/watchlist/widgets/watchlist_premium_loader.dart';
...
class _WatchlistScreenState extends State<WatchlistScreen> {
    ...
    return FeatureGuard(
      ...
      child: Scaffold(
        ...
        body: Stack(
          ...
          children: [
            IgnorePointer(
              ignoring: !_contentVisible,
              child: AnimatedOpacity(
                opacity: _contentVisible ? 1.0 : 0.0,
                duration: const Duration(milliseconds: 500),
                curve: Curves.easeOutCubic,
                child: _buildPageContent(isDark, pageBg),
              ),
            ),
            if (_showLoader)
              WatchlistPremiumLoader(
                onExitStart: _onLoaderExitStart,
  ...
  Widget _buildPageContent(bool isDark, Color pageBg) {
    return ColoredBox(
      color: pageBg,
      child: Column(
